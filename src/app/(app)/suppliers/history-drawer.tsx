...
export function HistoryDrawer({
  ...
  async function handleOpen() {
    ...
    setError(null);
    try {
      const result = await getSupplierHistory(supplierId, effectiveFrom || undefined, effectiveTo || undefined);
      setData(result);
    } catch (err) {
        ...
        >
          <div className="flex items-center justify-between border-b border-gray-200 px-5 py-4">
            <div>
              ...
              <p className="text-xs text-gray-500">Account history (Accounts Payable)</p>
