...
// The debit note form: the single invoice format (header, item lines, summary, Save) for a sales return.
export function SalesReturnForm({
  ...
  useEffect(() => {
    ...
    const dirty = Boolean(noteNumber.trim() || customerId || lines.some(isLineTouched));
    onDirtyChange(dirty);
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [noteNumber, customerId, lines]);
